...
const PptUploader = () => {
  ...
  const handleConvert = async () => {
    ...
    setError('');
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL || 'https://pdfstudio-backend.onrender.com'}/api/powerpoint-to-pdf/ppt-to-pdf`, formData, { responseType: 'blob' });
